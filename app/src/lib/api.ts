...
export const apiClient = new SagatClient(API_BASE_URL, 'cookie');
...
//       `/addresses/invitations/${encodeURIComponent(publicKey)}${params}`,
//     );
//   }
...
//     return this.request<{ publicKey: string; address: string }>(
//       `/addresses/${address}`,
//     );
//   }
// }
